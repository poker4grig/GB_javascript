...
const game = {
    ...
    renderGameScore() {
        ...
        currentScore.innerHTML = 'Ваш текущий счет: ' + this.gameScore();
    }
...
// 1.1 добавил в DOM заголовок h3
const myTable = document.getElementById('game');
myTable.insertAdjacentHTML('beforebegin', '<h3 class="score-string">Вывод текущего счета</h3>');
// 1.2. В объект game добавил метод gameScore, возвращающий счет (количество съеденной еды). 
// 1.3. В объект game добавил метод renderGameScore, который добавляет в заголовок h3 текст и сам счет игры.
// 1.4. Добавил вызов renderGameScore в методе render объекта game.
// 1.5. В CSS добавил стили классу score-string (заголовок, выводящий текст и счет).
